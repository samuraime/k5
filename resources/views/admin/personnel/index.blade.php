            ...
            <table id="data-table" class="am-table am-text-nowrap am-table-striped am-table-hover table-main">
                ...
                <tbody>
                    ...
                    <tr data-id="{{ $item['id'] }}">
                        ...
                        @endforeach
                        <td>
                            <a class="am-btn am-btn-default am-btn-xs am-text-secondary data-table-edit" href="{{ $url . '/edit?id=' . $item['id'] }}" target="_self"><span class="am-icon-pencil-square-o"></span>编辑</a>
